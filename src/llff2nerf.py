...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default=r"C:\Users\20638\Desktop\Study\2024_sem_2\计算机视觉\Final\data\nerf_llff_data\horns",
                        help="root directory to the LLFF dataset (contains images/ and pose_bounds.npy)")
    parser.add_argument('--images', type=str, default='images_8',
    ...
    # load data
    images = [f[len(opt.path):] for f in sorted(glob.glob(os.path.join(opt.path, opt.images, "*"))) if
